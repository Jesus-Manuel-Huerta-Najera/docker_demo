            ...
            <div class="column is-two-thirds is-flex is-flex-direction-column is-justify-content-space-between">
              ...
              <form action="guardar.php" method="POST">
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" name="nombre" id="nombre" placeholder="Text input" required>
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" name="email" id="email"  placeholder="hola@" required>
                  </div>
                </div>
                <div class="field">
                  <label class="label">Teléfono</label>
                  <div class="control">
                    <input class="input" type="number" name="telefono" id="telefono" placeholder="numero" required> 
                  </div>
                </div>
